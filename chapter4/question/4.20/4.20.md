# プログラミング課題4.20
## 課題内容
第３章で、ls -lの独自版を書いた。このプログラムを修正して、他の情報とともにinodeb何号も出力できるようにしなさい。
新しいlsはどこでinode番号を探すのか説明しなさい。
...
$ ./ls3 -i
: .
346077    4.20.md          346284    ls3              346286    ls3.c

$ ./ls3 -i -l
: .
346077    -rw-r--r--  1   taichi84   taichi84       7244 bytes   Sun Sep 21 19:56:21 2025   4.20.md
346284    -rwxr-xr-x  1   taichi84   taichi84      21264 bytes   Sun Sep 21 19:57:01 2025   ls3
346286    -rw-r--r--  1   taichi84   taichi84       6896 bytes   Sun Sep 21 19:54:16 2025   ls3.c

```

## inode番号はどこから取得できるのか。
stat構造体のst_inoにinode番号は格納されているので、そこから取得すればよい。
readdir()が返すstruct direneにもd_inoがあり、環境によってはそこから直接取得できるが、環境次第で上手く動かない場合もある。
標準的かつ確実なのはstat構造体のst_inoが確実である。
